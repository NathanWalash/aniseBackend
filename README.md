...
- **Automated Webhook Tests:**
  ...
  - The webhook test reads these IDs and simulates webhook events by POSTing example payloads to the backend, which then fetches the latest resource state from GoCardless and updates Firestore.
